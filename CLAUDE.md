...
- Code formatting: `bin/rubocop -A && trunk fmt -a` (auto-correct)
- Start app: `bin/mise dev` or `bin/mise dev:localhost` to use localhost instead of tailscale
- Database reset: `bin/mise db:reset`
