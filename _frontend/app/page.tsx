          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Educational resources about topics of gender for you and the people in your life.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Resources designed to support understanding and communication about gender.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
            <Card>
              ...
              <CardFooter>
                <Link href="/knowledge-base" className="flex items-center text-sm text-primary">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-xl font-bold">How Do I Say...?</CardTitle>
              ...
              <CardFooter>
                <Link href="/how-do-i-say" className="flex items-center text-sm text-primary">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Submit anonymous questions to a vetted team of responders. All topics are welcome.
                </p>
              </CardContent>
              <CardFooter>
                <Link href="/ask" className="flex items-center text-sm text-primary">
